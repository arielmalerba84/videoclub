...
<form  action="guardarpelicula.php" method="POST">
	...
	<input type="text" REQUIRED name="genero" placeholder="genero" value="">
	 </div>
	<div class="form-group" >
	<label>Director</label><br>
	<input type="text"REQUIRED name="director" placeholder="director" value=""> 
	 </div>
	<div class="form-group" >
	<label> Año</label><br>
	<input type="text" REQUIRED name="anio" placeholder="año" value="">
	 </div>
