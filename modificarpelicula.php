...
<div class="rounded bg-primary mt-3 mb-3 p-3 w-50">
	...
	<?php 
            ...
            $insertar = "SELECT * FROM pelicula WHERE id='$id'";
            $resultado = $conexion-> query($insertar);
            $fila=$resultado->fetch_assoc();
     ?>	

<h3>Modificar Datos Pelicula</h3> 

<form action="modificarpelicula_proceso.php?id=<?php echo $fila['id'];?>" method="POST">
	
           <div class="form-group" >
	<label for="exampleFormControlInput1"> Pelicula</label><br>
	<input  type="text" class="form-control-sm" id="exampleFormControlInput1" REQUIRED name="peli" value="<?php echo $fila['peli']; ?>"> 
          </div>
          <div class="form-group" >
	<label for="exampleFormControlInput1"> Genero</label><br>
	<input type="text" class="form-control-sm" id="exampleFormControlInput1" REQUIRED name="genero" value="<?php echo $fila['genero']; ?>">
	       </div>
	       <div class="form-group">
	<label  for="exampleFormControlInput1"> Director</label> <br>
	<input type="text" class="form-control-sm" id="exampleFormControlInput1"REQUIRED name="director" value="<?php echo $fila['director']; ?>"> 
	       </div>
	       <div class="form-group" >
	<label for="exampleFormControlInput1"> Año</label><br>
	<input type="text"  class="form-control-sm" id="exampleFormControlInput1" REQUIRED name="anio" value="<?php echo $fila['anio']; ?>"? >
	      </div>
	 <br>
