...
<head>
  ...
  <title> Ingresar Datos Pelicula</title>
</head>
<body  style="background-size: 100%; ;" background="eliminar.jpg">
  <div class="mt-2">
...
<center>
  ...
  <h3> Ingresar Datos Alquiler</h3>
<form  action="guardarpelicula.php" method="POST">

  <div class="form-group" >
  <label> Socio</label><br>
  <input type="text" REQUIRED name="socio" placeholder="socio" value=""> 
    </div>
    <div class="form-group" >
  <label> Pelicula</label><br>
  <input type="text" REQUIRED name="pelicula" placeholder="pelicula" value="">
   </div>
  <div class="form-group" >
  <label>Fecha Entrega</label><br>
  <input type="text"REQUIRED name="entrega" placeholder="entrega" value=""> 
   </div>
  <div class="form-group" >
  <label> Fecha Devolucion</label><br>
  <input type="text" REQUIRED name="devolucion" placeholder="devolucion" value="">
   </div>
